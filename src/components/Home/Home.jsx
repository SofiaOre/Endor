  ...
  return (
    <main>
              ...
              <div class="row text-center">
                <div class="col">
                  <div class="counter">
                    ...
                    <img src="assets/hus.png" alt="" width="60%" />

                  </div>
                </div>
                <div class="col">
                  <div class="counter">
                    <img src="assets/mc.png " alt="" width="70%" />

                  </div>
                </div>
                <div class="col">
                  <div class="counter">
                    <img src="assets/spear.png" alt="" width="75%" class="py-3" />

                  </div></div>
                <div class="col">
                  <div class="counter">
                    <img src="assets/stanley.png " alt="" width="80%" class="py-4" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div data-aos="zoom-out">
        <h3 class="py-3">QUIENES SOMOS</h3>
